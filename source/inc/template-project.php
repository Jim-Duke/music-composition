 ...
 * @return int
 */
function mc_get_project_id( $post_id = '' ) {
 ...
 * @return bool
 */
function mc_is_single_project( $post = '' ) {

	$is_single = is_singular( mc_get_project_post_type() );

	if ( $is_single && $post )
		$is_single = is_single( $post );

	return apply_filters( 'mc_is_single_project', $is_single, $post );
}
 ...
 * @return bool
 */
function mc_is_project_archive() {

	return apply_filters( 'mc_is_project_archive', is_post_type_archive( mc_get_project_post_type() ) && ! mc_is_author() );
}
 ...
 * @return bool
 */
function mc_is_project( $post_id = '' ) {

	$post_id = mc_get_project_id( $post_id );

	return apply_filters( 'mc_is_project', mc_get_project_post_type() === get_post_type( $post_id ), $post_id );
}
 ...
 * @return bool
 */
function mc_is_project_sticky( $project_id = 0 ) {
	$project_id = mc_get_project_id( $project_id );

	return apply_filters( 'mc_is_project_sticky', in_array( $project_id, mc_get_sticky_projects() ), $project_id );
}
 ...
 * @return bool
 */
function mc_is_project_complete( $post_id = '' ) {

	$post_id    = mc_get_project_id( $post_id );
	$completed  = true;
	$start_date = mc_get_project_meta( $post_id, 'start_date' );
	$end_date   = mc_get_project_meta( $post_id, 'end_date'   );
	...
	return apply_filters( 'mc_is_project_complete', $completed, $post_id );
}
 ...
 * @return bool
 */
function mc_is_project_in_progress( $post_id = '' ) {
	...
	return apply_filters( 'mc_is_project_in_progress', $in_progress, $post_id );
}
 ...
 * @return void
 */
function mc_project_url( $post_id = '' ) {

	$url = mc_get_project_url( $post_id );
 ...
 * @return string
 */
function mc_get_project_url( $post_id = '' ) {

	$post_id = mc_get_project_id( $post_id );

	return apply_filters( 'mc_get_project_url', mc_get_project_meta( $post_id, 'url' ), $post_id );
}
 ...
 * @return void
 */
function mc_project_link( $args = array() ) {
	echo mc_get_project_link( $args );
}
 ...
 * @return string
 */
function mc_get_project_link( $args = array() ) {

	$html = '';

	$defaults = array(
		'post_id' => mc_get_project_id(),
		'text'    => '%s',
		'before'  => '',
		'after'   => '',
		'wrap'    => '<a %s>%s</a>',
	...
	$url = mc_get_project_meta( $args['post_id'], 'url' );
	...
	return apply_filters( 'mc_get_project_link', $html, $args['post_id'] );
}
 ...
 * @return void
 */
function mc_project_client( $args = array() ) {
	echo mc_get_project_client( $args );
}
 ...
 * @return string
 */
function mc_get_project_client( $args = array() ) {
	...
	$client = mc_get_project_meta( $args['post_id'], 'client' );
	...
	return apply_filters( 'mc_get_project_client', $html, $args['post_id'] );
}
 ...
 * @return void
 */
function mc_project_location( $args = array() ) {
	echo mc_get_project_location( $args );
}
 ...
 * @return string
 */
function mc_get_project_location( $args = array() ) {
	...
	$location = mc_get_project_meta( $args['post_id'], 'location' );
	...
	return apply_filters( 'mc_get_project_location', $html, $args['post_id'] );
}
 ...
 * @return void
 */
function mc_project_start_date( $args = array() ) {
	echo mc_get_project_start_date( $args );
}
 ...
 * @return string
 */
function mc_get_project_start_date( $args = array() ) {
	...
	$start_date = mc_get_project_meta( $args['post_id'], 'start_date' );
	...
	return apply_filters( 'mc_get_project_start_date', $html, $args['post_id'] );
}
 ...
 * @return void
 */
function mc_project_end_date( $args = array() ) {
	echo mc_get_project_end_date( $args );
}
 ...
 * @return string
 */
function mc_get_project_end_date( $args = array() ) {
	...
	$end_date = mc_get_project_meta( $args['post_id'], 'end_date' );
	...
	return apply_filters( 'mc_get_project_end_date', $html, $args['post_id'] );
}
