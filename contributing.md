...
Original contributing.md from the custom-content-portfolio code this plugin was based on.  It needs to be updated once the new repository is established.

The code for the project is handled via its [GitHub Repository](TBD).  You can open tickets, create patches, and send pull requests there.
