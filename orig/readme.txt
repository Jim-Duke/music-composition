...
A solution for maintaining a catalog of music compositions that contain sheet
music, practice tracks, performances, and links to recordings.

== Description ==

TBD - Add a nice description.  This is the original language from
custom-content-portfolio.
...
* **Library:** Organize the entire collection into a Library.

TBD - Revise the features once those have been established.
...
* **Sticky Projects:** Stick projects to the Library page.
...
TBD Revise or remove this section.
